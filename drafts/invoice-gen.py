...
INVOICES = [
    dict(inv_date="2026-09-24", seq=1,
         ...
         paid_ref="FIN-2 · 28.07.2026 · $100 + $2 400 USDT (ERC-20)", note="Хвост 27–31.07 по договорённости сторон не выставлялся; фикс — с августа."),
    dict(inv_date="2026-09-24", seq=2,
         ...
         paid_ref="FIN-7 · 27.08.2026 · $3 900 USDT (ERC-20)", note="2 500 + 2 500 − 1 100 = 3 900 — по расчёту Kit 27.08 (FIN-4)."),
    dict(inv_date="2026-09-24", seq=3,
         ...
         paid_ref="FIN-12 · к оплате · 4 319 USDT (ERC-20) на 0x0C1E… · аппрув владельца 23.09", note="Как в FIN-12: вторая часть сентября + аванс октября − 681."),
]
