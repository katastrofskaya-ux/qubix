...
WALLET_1 = "USDT (ERC-20, Ethereum mainnet) 0xB7867007bDfe0e6c9Ff718489BD52604218fA3b7 (Designated Wallet, Clause 4.8)"
...
INVOICES = [
    dict(inv_date="2026-09-24", seq=1,
         period="August 2026 — first half of the monthly fee",
         lines=[("Consulting services under the Agreement — 50% of the monthly fee for August 2026 (Clause 4.2), paid early at the Consultant's request by agreement of the Parties", 2500.00)],
         paid="Paid on 28.07.2026 — USDT (ERC-20, Ethereum mainnet) to the Designated Wallet: 100 USDT (tx 0x922d980d75b79691bb0eec654cf26e4e3becaf1ce42360d76a58eeb1cfc3dec8) and 2,400 USDT (tx 0x0fabbb88c12f906e8fda60afeabfc8fca2d813d796b08cd016fcd6cb2da47abc)",
         paid_ref="FIN-2 · 28.07.2026 · $100 + $2 400 USDT (ERC-20, Ethereum mainnet)", note="Хвост 27–31.07 по договорённости сторон не выставлялся; фикс — с августа."),
    dict(inv_date="2026-09-24", seq=2,
         period="August 2026 — second half; September 2026 — first half",
         lines=[("Consulting services under the Agreement — remaining 50% of the monthly fee for August 2026 (Clause 4.2)", 2500.00),
                ("Consulting services under the Agreement — 50% of the monthly fee for September 2026 (Clause 4.2), paid early by agreement of the Parties", 2500.00),
         ...
         paid="Paid on 27.08.2026 — 3,900 USDT (ERC-20, Ethereum mainnet) to the Designated Wallet (tx 0x6ad8d1a8b121f7ef67bdb29576fa8039d70a864d119b181fb457b379bc74cacc)",
         paid_ref="FIN-7 · 27.08.2026 · $3 900 USDT (ERC-20, Ethereum mainnet)", note="2 500 + 2 500 − 1 100 = 3 900 — по расчёту Kit 27.08 (FIN-4)."),
