...
RELEASE_BASE = ("Здравствуйте{name}! Это Анастасия, CEO Qubix. Мы с вами общались {when}, и я обещала написать, когда выйдет большой релиз.\n\n"
                ...
                "Всё по-прежнему стоит на вашем сервере, данные остаются у вас.\n\n"
                "{personal}\n\n"
...
T_STUCK_NEW = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
               "Вы зарегистрировались у нас {ago}, но до установки на сервер пока не дошли. Установка занимает около двадцати минут: одна команда на вашем сервере, дальше мастер в браузере. Первый месяц бесплатный, со всеми возможностями.\n\n"
...
T_STUCK_OLD = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
               "Вы регистрировались у нас в {month}, до установки на сервер тогда не дошло. С тех пор вышел большой релиз — Qubix стал супераппом, теперь документы и таблицы команды живут прямо в панели. Бесплатный месяц у вас остаётся.\n\n"
