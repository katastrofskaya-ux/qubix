...
T_EXPIRING = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
              ...
              "Расскажите, как вам месяц в Qubix: что отметили для себя, с чем столкнулись в работе? Успели попробовать новые инструменты — документы и таблицы в панели, рабочий стол, скрипты к рекламному кабинету?")
T_EXPIRED = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
             ...
             "Расскажите, как вам месяц в Qubix: что отметили для себя, с чем столкнулись, что остановило? Успели попробовать документы, таблицы и рабочий стол?")
...
T_STUCK_OLD = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
               "Вы регистрировались у нас в {month}, до установки на сервер тогда не дошло. С тех пор вышел большой релиз: Qubix стал супераппом — рабочий стол, документы и таблицы в панели, скрипты к рекламному кабинету Facebook. Бесплатный месяц у вас остаётся.\n\n"
