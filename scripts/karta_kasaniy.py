...
RELEASE_BASE = ("Здравствуйте{name}! Это Анастасия, CEO Qubix. Мы с вами общались {when}, и я обещала написать, когда выйдет большой релиз.\n\n"
                ...
                "Всё по-прежнему стоит на вашем сервере, данные остаются у вас. Полный список изменений: docs.qubix.pro/ru/changelog/overview\n\n"
                "{personal}\n\n"
...
T_EXPIRING = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
              ...
              "Заодно: 28 августа у нас вышел большой релиз — Qubix стал супераппом, документы и таблицы команды теперь живут прямо в панели. Что в нём появилось: docs.qubix.pro/ru/changelog/overview\n\n"
...
T_EXPIRED = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
             ...
             "А 28 августа вышел большой релиз: Qubix стал супераппом, документы и таблицы команды теперь живут прямо в панели. Всё, что появилось: docs.qubix.pro/ru/changelog/overview\n\n"
...
T_STUCK_NEW = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
               "Вы зарегистрировались у нас {ago}, но до установки на сервер пока не дошли. Установка занимает около двадцати минут: одна команда на вашем сервере, дальше мастер в браузере. Первый месяц бесплатный, со всеми возможностями — про продукт коротко на qubix.pro\n\n"
...
T_STUCK_OLD = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
               "Вы регистрировались у нас в {month}, до установки на сервер тогда не дошло. С тех пор вышел большой релиз — Qubix стал супераппом, теперь документы и таблицы команды живут прямо в панели: docs.qubix.pro/ru/changelog/overview Бесплатный месяц у вас остаётся.\n\n"
...
T_PAYING = ("Здравствуйте! Это Анастасия, CEO Qubix.\n\n"
            "Вы с нами с июля, и мне важно, чтобы у вас всё работало как надо. Что вышло в релизе 28 августа: docs.qubix.pro/ru/changelog/overview\n\n"
...
T_BOT = ("Здравствуйте{name}! Меня зовут Анастасия, я CEO Qubix.\n\n"
         "Вы {when} обращались к нашему боту и смотрели демо, но аккаунт пока не завели. Qubix ставится на ваш сервер, первый месяц бесплатный со всеми возможностями — отвечу на любые вопросы и помогу с запуском.\n\n"
