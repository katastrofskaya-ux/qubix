...
RELEASE_BASE = ("Здравствуйте{name}! Это Анастасия, CEO Qubix. Мы с вами общались {when}, и я обещала написать, когда выйдет большой релиз.\n\n"
                ...
                "{personal}\n\n"
                "Готова открыть вам доступ на 30 дней заново и помочь дойти до первой связки. Когда вам удобно созвониться?")
PERSONAL = {
...
T_EXPIRING = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
              ...
              "Расскажите, как идёт работа: сервер развернули, первую связку запустили? Если где-то застряли — где именно?")
