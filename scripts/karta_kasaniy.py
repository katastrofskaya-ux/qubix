...
T_EXPIRING = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
              ...
              "Решите продолжать —{disc} помогу оформить.")
T_EXPIRED = ("Здравствуйте! Меня зовут Анастасия, я CEO Qubix.\n\n"
             ...
             "Данные и настройки на вашем сервере сохранены, вернуться можно в любой момент — помогу оформить.")
...
for c in clients:
    ...
    if n in SKIP:
        ...
        disc = " по вашему коду скидка 50%," if DISCOUNT.get(c["code"], 0) == 50 else ""
