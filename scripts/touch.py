...
# ⚠️ Эти же записи выкидываются из замера: контрагент, зарегистрировавшийся по
# своему же коду, приписывает себе отдачу размещения. Найдено перепроверкой
# 21.09.2026 — вторые аккаунты уже известных людей плюс две новые записи.
OURS = {201: "Будда", 107: "AdsPower", 228: "Хоменок", 190: "Marta",
        204: "Будда, второй аккаунт", 233: "Хоменок, аккаунт агентства x6",
        206: "Женя, наш копирайтер", 241: "Partnerkin, сама площадка"}
...
Расскажите, что получилось посмотреть за это время: развернули на своём сервере, дошли до первой связки? Если какой-то шаг остался мутным — разберём вместе, поддержка на связи.
...
Захотите вернуться — ваши данные и настройки на вашем сервере в целости, доступ возвращается одним шагом. Помогу пройти его, поддержка на связи."""
